 ...
 */
public class RecyclerViewAdapterCompany extends RecyclerView.Adapter<RecyclerViewAdapterCompany.MyViewHolder> {

    private ArrayList<Appalto> appList;

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView id, azienda, citta;
    ...
    public RecyclerViewAdapterCompany(ArrayList<Appalto> appList) {
        this.appList = appList;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_row_company_list, parent, false);
